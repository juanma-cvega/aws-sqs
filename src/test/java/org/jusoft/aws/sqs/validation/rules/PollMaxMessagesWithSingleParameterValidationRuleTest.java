...
import static org.jusoft.aws.sqs.validation.rules.PollMaxMessagesWithSingleParameterValidationRule.DEFAULT_MAX_MESSAGES_PER_POLL;
import static org.jusoft.aws.sqs.validation.rules.PollMaxMessagesWithSingleParameterValidationRule.DEFAULT_MIN_MESSAGES_PER_POLL;
import static org.jusoft.aws.sqs.validation.rules.PollMaxMessagesWithSingleParameterValidationRule.MAXIMUM_NUMBER_OF_MESSAGES_PER_POLL_ERROR;
import static org.jusoft.aws.sqs.validation.rules.PollMaxMessagesWithSingleParameterValidationRule.MINIMUM_NUMBER_OF_MESSAGES_PER_POLL_ERROR;
import static org.jusoft.aws.sqs.validation.rules.PollMaxMessagesWithSingleParameterValidationRule.NO_COLLECTION_PARAMETER_WITH_MAX_MESSAGES_GREATER_THAN_ONE_ERROR;
